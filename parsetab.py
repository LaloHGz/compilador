...
_lr_productions = [
  ...
  ('CTE -> CTE_INT ACTION_1_2_INT','CTE',2,'p_CTE','parser_1.py',158),
  ('CTE -> CTE_FLOAT ACTION_1_2_FLOAT','CTE',2,'p_CTE','parser_1.py',159),
  ('ACTION_1_2_ID -> <empty>','ACTION_1_2_ID',0,'p_action_1_2_id','parser_1.py',162),
  ('ACTION_1_2_INT -> <empty>','ACTION_1_2_INT',0,'p_action_1_2_int','parser_1.py',167),
  ('ACTION_1_2_FLOAT -> <empty>','ACTION_1_2_FLOAT',0,'p_action_1_2_float','parser_1.py',171),
  ('ACTION_2_2 -> <empty>','ACTION_2_2',0,'p_action_2_2','parser_1.py',175),
  ('ACTION_3_2 -> <empty>','ACTION_3_2',0,'p_action_3_2','parser_1.py',179),
  ('ACTION_4_2 -> <empty>','ACTION_4_2',0,'p_action_4_2','parser_1.py',183),
  ('ACTION_5_2 -> <empty>','ACTION_5_2',0,'p_action_5_2','parser_1.py',197),
  ('ACTION_6_2 -> <empty>','ACTION_6_2',0,'p_action_6_2','parser_1.py',211),
  ('ACTION_7_2 -> <empty>','ACTION_7_2',0,'p_action_7_2','parser_1.py',215),
  ('ACTION_8_2 -> <empty>','ACTION_8_2',0,'p_action_8_2','parser_1.py',219),
  ('ACTION_9_2 -> <empty>','ACTION_9_2',0,'p_action_9_2','parser_1.py',223),
  ('ACTION_10_2 -> <empty>','ACTION_10_2',0,'p_action_10_2','parser_1.py',238),
  ('PRINTF -> PRINT LPARENTHESES List_expresions RPARENTHESES SEMICOLON','PRINTF',5,'p_PRINTF','parser_1.py',252),
  ('List_expresions -> Opt_exp ACTION_2_PRINT More_expresions','List_expresions',3,'p_List_expresions','parser_1.py',255),
  ('Opt_exp -> EXPRESION','Opt_exp',1,'p_Opt_exp','parser_1.py',258),
  ('Opt_exp -> CTE_STRING ACTION_1_PRINT','Opt_exp',2,'p_Opt_exp','parser_1.py',259),
  ('More_expresions -> COMMA List_expresions','More_expresions',2,'p_more_expresions','parser_1.py',262),
  ('More_expresions -> vacio','More_expresions',1,'p_more_expresions','parser_1.py',263),
  ('ACTION_1_PRINT -> <empty>','ACTION_1_PRINT',0,'p_action_1_print','parser_1.py',266),
  ('ACTION_2_PRINT -> <empty>','ACTION_2_PRINT',0,'p_action_2_print','parser_1.py',270),
  ('CYCLE -> DO ACTION_1_DW BODY WHILE LPARENTHESES EXPRESION RPARENTHESES SEMICOLON ACTION_2_DW','CYCLE',9,'p_CYCLE','parser_1.py',276),
  ('ACTION_1_DW -> <empty>','ACTION_1_DW',0,'p_action_1_dw','parser_1.py',279),
  ('ACTION_2_DW -> <empty>','ACTION_2_DW',0,'p_action_2_dw','parser_1.py',283),
  ('CONDITION -> IF LPARENTHESES EXPRESION RPARENTHESES ACTION_1_IF BODY Else_condition SEMICOLON ACTION_2_IF','CONDITION',9,'p_CONDITION','parser_1.py',292),
  ('Else_condition -> ELSE ACTION_3_IF BODY','Else_condition',3,'p_Else_condition','parser_1.py',295),
  ('Else_condition -> vacio','Else_condition',1,'p_Else_condition','parser_1.py',296),
  ('F_CALL -> ID LPARENTHESES F_expresion RPARENTHESES SEMICOLON','F_CALL',5,'p_F_call','parser_1.py',299),
  ('F_expresion -> List_fexpresions','F_expresion',1,'p_F_expresion','parser_1.py',302),
  ('F_expresion -> vacio','F_expresion',1,'p_F_expresion','parser_1.py',303),
  ('List_fexpresions -> EXPRESION More_fexpresions','List_fexpresions',2,'p_List_fexpresions','parser_1.py',306),
  ('More_fexpresions -> COMMA List_fexpresions','More_fexpresions',2,'p_More_fexpresions','parser_1.py',309),
  ('More_fexpresions -> vacio','More_fexpresions',1,'p_More_fexpresions','parser_1.py',310),
  ('ACTION_1_IF -> <empty>','ACTION_1_IF',0,'p_action_1_if','parser_1.py',313),
  ('ACTION_2_IF -> <empty>','ACTION_2_IF',0,'p_action_2_if','parser_1.py',322),
  ('ACTION_3_IF -> <empty>','ACTION_3_IF',0,'p_action_3_if','parser_1.py',327),
  ('vacio -> <empty>','vacio',0,'p_vacio','parser_1.py',339),
]
